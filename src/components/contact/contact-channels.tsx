...
const SOCIALS: Social[] = [
  {
    label: "Facebook",
    href: "https://facebook.com/khadyskitchen",
    icon: (
  ...
  {
    label: "X (Twitter)",
    href: "https://x.com/khadyskitchen",
    icon: (
  ...
  {
    label: "TikTok",
    href: "https://tiktok.com/@khadyskitchen",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="h-[18px] w-[18px]">
        ...
        <div className="flex justify-center gap-3.5">
          {SOCIALS.map((s) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="grid h-[50px] w-[50px] place-items-center rounded-full border-[1.5px] border-ink/15 text-ink transition-colors hover:border-accent hover:bg-accent hover:text-[#FDFAF3]"
            >
              {s.icon}
            </a>
          ))}
